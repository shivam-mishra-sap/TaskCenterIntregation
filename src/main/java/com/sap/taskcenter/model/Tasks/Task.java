...
public class Task {
    ...
    private List<RecipientUsers> recipientUsers;
    private List<RecipientGroups> recipientGroups;
    ...
    public List<RecipientUsers> getRecipientUsers() {
        return recipientUsers;
    }

    public void setRecipientUsers(List<RecipientUsers> recipientUsers) {
        this.recipientUsers = recipientUsers;
    }

    public List<RecipientGroups> getRecipientGroups() {
        return recipientGroups;
    }

    public void setRecipientGroups(List<RecipientGroups> recipientGroups) {
